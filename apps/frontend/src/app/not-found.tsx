    ...
    <html lang="ar">
      ...
      <body className="m-0 p-0 font-sans antialiased bg-[#0F1A2E] text-white flex items-center justify-center min-h-screen text-center">
        <div className="max-w-md px-6">
          <h1 className="text-8xl font-black text-[#0EA5E9] m-0">404</h1>
          ...
          <a
            href="/ar"
            className="inline-flex items-center gap-2 px-8 py-3 rounded-xl text-base font-bold transition-all hover:opacity-90 active:scale-95 bg-[#0EA5E9] text-[#0F1A2E]"
          >
            العودة للرئيسية
          </a>
        </div>
