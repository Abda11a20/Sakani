  ...
  return (
    <TenantLayout>
      <div className="space-y-8">
        ...
        <Card className="border border-slate-200 rounded-3xl overflow-hidden bg-white shadow-sm">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 font-cairo">
            ...
            {/* Premium Plan Card */}
            <Card className="border-2 border-amber-400 bg-white rounded-3xl shadow-md overflow-hidden relative">
              <div className="absolute top-0 right-0 left-0 bg-gradient-to-r from-[#0EA5E9] to-[#0284C7] text-white text-center py-1.5 text-xs font-bold font-cairo">
                الباقة الموصى بها 🔥
              </div>
        ...
        <div className="space-y-4">
          ...
          <Card className="border border-slate-200 rounded-3xl overflow-hidden bg-white shadow-sm font-cairo">
                    ...
                    <tbody className="divide-y divide-slate-100">
                      {history.map((item) => (
                        <tr key={item.id} className="text-slate-700 hover:bg-slate-50/50">
                          ...
                          <td className="py-4 px-6 font-mono font-bold text-green-600">
                            {item.amount / 100} ج.م
                          </td>
                          <td className="py-4 px-6">
                            {item.status === "active" ? (
                              <span className="inline-block py-1 px-2.5 rounded-full text-[10px] font-bold bg-green-100 text-green-800">
                                نشط
                              </span>
                            ) : (
                              <span className="inline-block py-1 px-2.5 rounded-full text-[10px] font-bold bg-slate-100 text-slate-600">
                                {item.status}
                              </span>
                            )}
                          </td>
        ...
        {isUpgradeModalOpen && (
          ...
          >
            <form onSubmit={handleSubmit(handleUpgradeSubmit)} className="p-6 space-y-4 font-cairo">
              <div className="flex gap-2 p-3 bg-[#0EA5E9]/10 text-amber-700 border border-[#0EA5E9]/20 rounded-2xl text-xs mb-2">
